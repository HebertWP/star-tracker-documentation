...
% ---
\titulo{Desenvolvimento de um rastreador estrelar para determinação de atitude de cubesats}
...
\preambulo{Trabalho apresentado \`{a} Faculdade de Engenharia Mecânica da Universidade Estadual de Campinas como parte dos requisitos exigidos para a obten\c{c}\~{a}o do t\'{\i}tulo de Engenheiro de Controle e automação.}
% --- 